...
export default function Login() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="max-w-md w-full space-y-8 glass-dark p-10 rounded-2xl border border-primary/30 shadow-2xl shadow-primary/20 relative z-10">
                ...
                <div className="mt-8">
                    <button
                        ...
                        className="group relative w-full flex justify-center items-center gap-3 py-4 px-6 border-2 border-primary/30 text-base font-medium rounded-lg text-white bg-gradient-to-r from-primary/10 to-secondary/10 hover:from-primary/20 hover:to-secondary/20 hover:border-primary/50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-all shadow-lg hover:shadow-primary/30"
                    >
