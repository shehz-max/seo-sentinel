...
function LoginContent() {
    ...
    const handleEmailLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            console.error(err);
            setError(err.message?.includes("invalid-credential") ? "Invalid email or password" : "Login failed. Please try again.");
        } finally {
                ...
                <div className="mt-8 space-y-6">
                    ...
                    <form onSubmit={handleEmailLogin} className="space-y-4">
                        ...
                        <button
                            ...
                            className="w-full py-3.5 rounded-xl bg-primary hover:bg-primary-dark text-white font-bold transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-primary/20"
                        >
                    ...
                    <div className="relative">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-2 bg-[#0B0F19] text-gray-400">Or continue with</span>
                        </div>
                    </div>
...
export default function Login() {
    return (
        <Suspense fallback={<div className="min-h-screen flex items-center justify-center bg-[#020617] text-white">Loading Login...</div>}>
            <LoginContent />
        </Suspense>
    );
}
